        ...
        <div className="grid lg:grid-cols-5 gap-4 p-4">
            ...
            <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full p-4 rounded-lg">
                <div className="flex flex-col w-full pb-4">
                    <p className="text-2xl font-bold">$7,654</p>
            ...
            <div className="lg:col-span-2 col-span-1 bg-white flex justify-between w-full p-4 rounded-lg">
                <div className="flex flex-col w-full pb-4">
                    <p className="text-2xl font-bold">$1,327,257</p>
                    <p className="text-gray-600">YDT Revenue</p>
                </div>
                <p className="bg-green-200 flex justify-center items-center p-2 rounded-lg">
            ...
            <div className="bg-white flex justify-between w-full p-4 rounded-lg">
                <div className="flex flex-col w-full pb-4">
                    <p className="text-2xl font-bold">$73,133</p>
                    <p className="text-gray-600">Costumers</p>
                </div>
                <p className="bg-green-200 flex justify-center items-center p-2 rounded-lg">
                    <span className="text-green-700 text-lg">+42%</span>
                </p>
            </div>
